...
fn resolve_saved_oauth_token_set(
    ...
    let client = OpenyakApiClient::from_auth(AuthSource::None).with_base_url(read_base_url());
...
impl Provider for OpenyakApiClient {
...
mod tests {
    ...
    use super::{
        ...
        resolve_startup_auth_source, AuthSource, OAuthTokenSet, OpenyakApiClient,
    };
    ...
    fn backoff_doubles_until_maximum() {
        let client = OpenyakApiClient::new("test-key").with_retry_policy(
            3,
