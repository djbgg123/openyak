...
impl PermissionMode {
    ...
    #[must_use]
    fn auto_allows(self, required_mode: Self) -> bool {
        match self {
            Self::Allow => true,
            Self::Prompt | Self::ReadOnly => required_mode == Self::ReadOnly,
            Self::DangerFullAccess => matches!(
                required_mode,
                Self::ReadOnly | Self::WorkspaceWrite | Self::DangerFullAccess
            ),
            Self::WorkspaceWrite => {
                matches!(required_mode, Self::ReadOnly | Self::WorkspaceWrite)
            }
        }
    }
...
impl PermissionPolicy {
    ...
    pub fn authorize(
        ...
        if current_mode.auto_allows(required_mode) {
...
mod tests {
    ...
    #[test]
    fn prompt_mode_prompts_for_dangerous_tools() {
    ...
    #[test]
    fn prompt_mode_allows_read_only_tools_without_prompt() {
        let policy = PermissionPolicy::new(PermissionMode::Prompt)
            .with_tool_requirement("read_file", PermissionMode::ReadOnly);
