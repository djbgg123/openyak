...
最近一次全量文档与命令面对齐完成于 `2026-04-08`。本文内容已对照当前 `openyak --help` / `openyak skills help` / `openyak foundations --help` / `openyak server --help`、最新一轮 58 步 release-binary 逐命令 rerun，以及 Rust、根目录 Python、Python SDK、TypeScript SDK 四条本地验证链路收口。
